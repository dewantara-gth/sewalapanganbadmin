...
<div class="max-w-lg mx-auto mt-10 bg-white border border-gray-200 rounded-xl shadow-lg p-8 font-sans">
    ...
    <div class="text-center">
        <a href="{{ route('booking.cek.form') }}" class="inline-block mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Cek Booking Lainnya</a>
    </div>
</div>
@endsection
